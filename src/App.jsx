    ...
    <div className="wrapper">
      ...
      <div className="header">
        <div className="header-left">
          <img height={40} width={40} src="/img/logo.png" alt="logo"/>
            <div className="headerInfo">
              <h3 className="uppercase">React Sneackers</h3>
        ...
        <ul className="header-right">
          ...
          <li>
            <svg width="18" height="18" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="content"> 
              ...
              <div className="favorite">
                ...
                <div className="cardBottom">
                  ...
                  <button>
                    ...
                    <rect x="0.5" y="0.5" width="31" height="31" rx="7.5" fill="dedddd" />
            ...
            <div className="card">
                <img className="sneacker" width={133} height={112} src="/img/sneakers/5.jpg" alt="nike"/>
                <h5>Мужские кроссовки Nike Blazer Mid Suede</h5>
                <div className="cardBottom">
                  <div className="bottomDesc">
                    <span>Цена:</span>
            ...
            <div className="card">
                <img className="sneacker" width={133} height={112} src="/img/sneakers/2.jpg" alt="nike"/>
                <h5>Мужские кроссовки Nike Blazer Mid Suede</h5>
                <div className="cardBottom">
                  <div className="bottomDesc">
                    <span>Цена:</span>
            ...
            <div className="card">
                <img className="sneacker" width={133} height={112} src="/img/sneakers/3.jpg" alt="nike"/>
                <h5>Мужские кроссовки Nike Blazer Mid Suede</h5>
                <div className="cardBottom">
                  <div className="bottomDesc">
                    <span>Цена:</span>
            ...
            <div className="card">
                <img className="sneacker" width={133} height={112} src="/img/sneakers/4.jpg" alt="nike"/>
                <h5>Мужские кроссовки Nike Blazer Mid Suede</h5>
                <div className="cardBottom">
                  <div className="bottomDesc">
                    <span>Цена:</span>
